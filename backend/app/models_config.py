...
MODEL_ROUTES: dict[str, ModelRoute] = {
    ...
    "seedream-5": ModelRoute(
        ...
        provider="fal",
        fal_id="fal-ai/bytedance/seedream/v5/lite/text-to-image",
        modality=Modality.TEXT_TO_IMAGE,
        tier=Tier.PREMIUM,
        prompt_style="flux",
    ...
    "veo-31-lite": ModelRoute(
        ...
        provider="google",
        fal_id=None,
        google_id="veo-3.1-lite-generate-preview",
        modality=Modality.TEXT_TO_VIDEO,
        tier=Tier.DRAFT,
        prompt_style="veo",
    ...
    "seedance-2": ModelRoute(
        ...
        label="Seedance 2.0",
        provider="fal",
        fal_id="bytedance/seedance-2.0/text-to-video",
        modality=Modality.TEXT_TO_VIDEO,
        tier=Tier.PREMIUM,
